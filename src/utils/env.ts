...
export const CONSTANTS = {
  ...
  CERTIFICATE_QR_GENERATOR_URL : env.CERTIFICATE_QR_GENERATOR_URL || 'https://aryon8qv9d.execute-api.ap-south-1.amazonaws.com/prod/certificateQRGenerator', 
  CERTIFICATE_QR_GENERATOR_API_KEY : env.CERTIFICATE_QR_GENERATOR_API_KEY || ''
}
